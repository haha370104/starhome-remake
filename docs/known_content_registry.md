...
| 类型 | 已知注册 | 来源覆盖 | 当前 runtime 映射 |
| --- | ---: | --- | ---: |
| 地图 | 814 | 6 个世界、497 组场景资源 | 10 个来源键映射至 4 张业务地图 |
...
多个荣耀世界分支可能共用同一个复刻版业务定义，例如 NFT_BL、NFT_BT、NFT_BTB、NFT_PL
的 D04 来源键目前都映射到 `d04_field_zone`。查询 runtime 映射返回数组，以保留这种多对一
