...
func vehicle_combat_loadout(
	...
	for ability_id: String in weapons:
		...
		var bonus := player.vehicle.loadout.attachment_bonus(effect) + player.vehicle.loadout.socket_bonus(effect) + player.vehicle.loadout.generator_bonus(effect) + player.vehicle.loadout.special_bonus(effect) + player.central.bonus(effect, player.vehicle.loadout, player.vehicle.central_rules)
