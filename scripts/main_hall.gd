...
const MAP_TEXTURE_PATH := "res://assets/maps/yian_harbor/hall_floor_1/floor.png"
const MINIMAP_TEXTURE_PATH := "res://assets/maps/yian_harbor/hall_floor_1/minimap.jpg"
const NAV_DATA_PATH := "res://assets/maps/yian_harbor/hall_floor_1/navigation_grid.bin"
