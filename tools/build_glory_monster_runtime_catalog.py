...
def presentation(row: dict[str, str]) -> dict[str, Any]:
    ...
    return {
        ...
        "hit_effect": row.get("attr_24", ""),
        "projectile": row.get("attr_26", ""),
        "death_effect": row.get("attr_27", ""),
        "death_sound": row.get("attr_28", ""),
        "attack_sound": row.get("attr_29", ""),
        "palette": row.get("attr_32", ""),
        "directions": 8,
        "fps": 10,
    }
