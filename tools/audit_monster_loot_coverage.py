...
def main():
    ...
    lines = ["# 怪物物品掉落覆盖审计", "", "2026-09-16，使用初始化后的权威目录（含新手覆盖及材料补充表）。", "",
             ...
             "原版候选已转换为独立25%的复刻配置，原始权重仅保留作为证据。接合器碎片另遵循用户限定。", "",
             "## D03 与隐形掉落修复", "",
             "低温毒胶：低级类胶1～3、中级类胶1～3、低级能量包2～4；每项独立25%。",
             "低温感光质：低级能量催化剂1～3、中级能量催化剂1～3、低级能量包2～4；每项独立25%。",
             "两者过去只有掉落规则，没有地面表现，导致客户端拒绝创建视图。",
             "全部79种候选已具备地面/背包表现；原表同怪同物品重复行合并为一次抽取，数量取原范围的并集边界。",
