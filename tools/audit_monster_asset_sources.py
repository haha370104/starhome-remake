...
ALE = {
    ...
    "orb_standard_move": "pic3/npc/71-1.ale",
    "orb_standard_idle": "pic3/npc/71-2.ale",
    "orb_cold_move": "pic3/npc/75-1.ale",
    "orb_cold_idle": "pic3/npc/75-2.ale",
    "orb_malignant_move": "pic3/npc/79-1.ale",
    "orb_malignant_idle": "pic3/npc/79-2.ale",
...
ASSETS: dict[str, tuple[str, str | None]] = {
    ...
    "photosensitive_orb/variants/standard/idle": ("orb_standard_idle", None),
    "photosensitive_orb/variants/cold/move_attack": ("orb_cold_move", None),
    "photosensitive_orb/variants/cold/idle": ("orb_cold_idle", None),
    "photosensitive_orb/variants/malignant/move_attack": ("orb_malignant_move", None),
    "photosensitive_orb/variants/malignant/idle": ("orb_malignant_idle", None),
