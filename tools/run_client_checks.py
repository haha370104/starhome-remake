...
TESTS = (
    ...
    "server/persistence/austin_glens_runtime_test.gd",
    "ui/runtime/austin_glens_panel_test.gd",
    "domain/crystal_source_model_test.gd",
    "domain/crystal_source_integration_test.gd",
    "domain/crystal_source_actions_test.gd",
    "server/commerce/crystal_source_authority_test.gd",
    "server/persistence/crystal_source_runtime_test.gd",
    "ui/runtime/crystal_source_panel_test.gd",
    ...
    "server/persistence/warehouse_snapshot_test.gd",
    ...
    "server/persistence/skill_progression_runtime_test.gd",
